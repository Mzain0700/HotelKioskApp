  ...
  Future<void> _validateCheckout() async {
    ...
    try {
      ...
      if (bookingSnapshot.docs.isNotEmpty) {
        ...
        final nightsStayed = checkOutDate.difference(checkInDate).inDays;
        ...
        Navigator.of(context).push(
          MaterialPageRoute(
            builder: (_) => CheckoutDetailsScreen(
              ...
              roomRate: bookingData['roomRate'] ?? 100.0, // Default to 100 if not available
            ),
          ),
        );
      } else {
      ...
      print('Error validating checkout: $e');
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
                ...
                child: SizedBox(
                  ...
                  child: Column(
                    ...
                    children: [
                      Center(
                        child: Text(
                          _localizations.get('self_check_out'),
                      ...
                      Center(
                        child: SizedBox(
                          ...
                          child: ElevatedButton(
                            onPressed: _fieldsAreFilled && !_isLoading ? _validateCheckout : null,
